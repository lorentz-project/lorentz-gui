...
AddressBook::AddressBook(Lorentz::AddressBook *abImpl,QObject *parent)
...
QList<Lorentz::AddressBookRow*> AddressBook::getAll(bool update) const
{
    qDebug(__FUNCTION__);
...
Lorentz::AddressBookRow * AddressBook::getRow(int index) const
{
