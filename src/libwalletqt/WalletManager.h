...
public:
    enum LogLevel {
        LogLevel_Silent = Lorentz::WalletManagerFactory::LogLevel_Silent,
        LogLevel_0 = Lorentz::WalletManagerFactory::LogLevel_0,
        LogLevel_1 = Lorentz::WalletManagerFactory::LogLevel_1,
        LogLevel_2 = Lorentz::WalletManagerFactory::LogLevel_2,
        LogLevel_3 = Lorentz::WalletManagerFactory::LogLevel_3,
        LogLevel_4 = Lorentz::WalletManagerFactory::LogLevel_4,
        LogLevel_Min = Lorentz::WalletManagerFactory::LogLevel_Min,
        LogLevel_Max = Lorentz::WalletManagerFactory::LogLevel_Max,
    };
