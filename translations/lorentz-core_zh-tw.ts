...
<context>
    ...
    <message>
        ...
        <translation>挖礦可增進 Lorentz 網路的安全性，只要越多使用者在挖礦，Lorentz 網路就會越難以被攻擊。&lt;br&gt; &lt;br&gt;挖礦也同時提供您機會賺取一些額外的 Lorentz 幣，因為在挖礦時，您的電腦將被用來尋找 Lorentz 區塊的解答，每當您找到一個區塊的解答，您即可以獲得其附帶的獎勵金，祝您好運！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Lorentz多於預期金額</translation>
    </message>
    <message>
        <location filename="../pages/Receive.qml" line="139"/>
        <source>With not enough Lorentz</source>
        <translation>Lorentz少於預期金額</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>內嵌 Lorentz 版本: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>本頁面可以讓你對共享環簽資料庫進行操作，這個資料庫可以讓Lorentz錢包與其重複使用金鑰的分叉幣錢包共享環簽資訊。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>為了要混淆Lorentz真實被花用過的交易輸入，第三方不應能得知在環簽內的交易組合中哪一個交易是已經被花用的，否則環簽的保護效果將被減弱。若被觀察出只有一個交易輸出是尚未被花用的則該筆交易的來源將會變得顯而易見，也就等於損失了Lorentz的三大保護隱私保護其中之一: 環狀簽名。&lt;br&gt;若要避免發生這類狀況，一個已知被花用的交易輸出名單可以用來避免在新的交易中使用到這些輸出，此份名單是由Lorentz專案所維護，可以在getlorentz.org網站上找到並在此匯入。&lt;br&gt;或是你可以選擇使用lorentz-blockchain-blackball tool自行掃描區塊鏈(與重複使用金鑰的分叉幣區塊鏈)以產生該份名單。&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>為了避免讓Lorentz的環狀簽名保護失效，一個交易輸出應避免在不同的區塊鏈中以不同的環簽組合所花用。這通常不需要擔心，但當你在重複使用金鑰的分叉幣區塊鏈上花用現有的交易輸出時就得注意，必需在兩條鏈上使用相同的環簽組合。&lt;br&gt;這個保護措施在Lorentz或其他注重保護你的隱私的軟體中重複使用金鑰時都應是自動完成的。&lt;br&gt;如果你正在使用重複使用金鑰的分叉幣且該幣並未包含此保護措施，你必須先於分叉幣上花用交易，再將環簽在此匯入以確保您的Lorentz交易隱私安全。&lt;br&gt;若你沒有使用未經保護的分叉幣則不須任何處置，因為這保護措施將會自動完成。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>這記錄著在Lorentz鏈上所使用過的環狀簽名組合，因此相同組合應在重複金鑰的分叉鏈上沿用以確保隱私安全。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Lorentz發送成功</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>就快完成了 - Lorentz 還需要一點設定</translation>
    </message>
    <message>
        <location filename="../wizard/WizardConfigure.qml" line="97"/>
        <source>Kickstart the Lorentz blockchain?</source>
        <translation>開始同步 Lorentz 區塊鏈?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>硬碟節約模式能精簡區塊鏈的資料而減少硬碟空間的使用量，但保存完整的區塊鏈能加強 Lorentz 網路的安全性，當您需要在容量較小的硬碟上執行，那麼這個功能就很適合您，此功能對於網路頻寬的用量沒有影響。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>啟動挖礦功能可讓 Lorentz 的系統網路更加安全，且在工作完成時獲得小額的獎勵金。這個功能只會在電腦插著電源並且閒置時才會自動啟動，當您繼續使用電腦後即會停止挖礦。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>為了連接至Lorentz的交易網路，你必須連接至Lorentz的節點。為了確保最佳的隱私狀態，我們建議你可以運行自己的節點。                         &lt;br&gt;&lt;br&gt;                         如果真的不方便運行自己的節點，你可以選擇連接至遠端的節點。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Lorentz的開發完全由贊助所支持</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>在每一筆交易中 Lorentz 系統都會收取小額的手續費，而這個選項則是讓你可以增加額外的金額贊助 Lorentz 的開發，比例以當次交易的手續費計算，譬如 50% 的自動贊助將會從0.005 XMR的手續費算出 0.0025 XMR 的金額贊助給 Lorentz 開發團隊。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Mining secures the Lorentz network, and also pays a small reward for the work done. This option will let Lorentz mine when your computer is on mains power and is idle. It will stop mining when you continue working.</source>
        <translation>啟動挖礦功能可讓 Lorentz 的網路更加安全，且在工作完成時獲得小額的獎勵金。這個功能只會在電腦插著電源並且閒置時才會自動啟動，當您繼續使用電腦後即會停止挖礦。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>開始使用LORENTZ</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>歡迎使用 Lorentz！</translation>
    </message>
    <message>
...
轉出位址索引: </translation>
    ...
    <message>
        ...
        <translation>Lorentz發送成功: %1 筆交易</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>有可用的新版本 Lorentz 錢包:  %1&lt;br&gt;%2</translation>
    </message>
    <message>
