...
public:
    enum Status {
        Status_Ok       = Lorentz::UnsignedTransaction::Status_Ok,
        Status_Error    = Lorentz::UnsignedTransaction::Status_Error,
        Status_Critical    = Lorentz::UnsignedTransaction::Status_Critical
    };
    Q_ENUM(Status)
...
private:
    explicit UnsignedTransaction(Lorentz::UnsignedTransaction * pt, Lorentz::Wallet *walletImpl, QObject *parent = 0);
    ~UnsignedTransaction();
private:
    friend class Wallet;
    Lorentz::UnsignedTransaction * m_pimpl;
    QString m_fileName;
