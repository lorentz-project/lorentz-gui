...
public:
    enum Direction {
        Direction_In  =  Lorentz::TransactionInfo::Direction_In,
        Direction_Out =  Lorentz::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Lorentz::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Lorentz::TransactionInfo * m_pimpl;
